...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
		self.color = [UIColor colorWithRed:248.0/255.0 green:248.0/255.0 blue:248.0/255.0 alpha:1.0];
        self.labelFont = [UIFont systemFontOfSize:kLabelFontSize];
        self.labelColor = [UIColor colorWithRed:51.0/255.0 green:51.0/255.0 blue:51.0/255.0 alpha:1.0];
        self.detailsLabelFont = [UIFont systemFontOfSize:kDetailsLabelFontSize];
        self.detailsLabelColor = [UIColor colorWithRed:51.0/255.0 green:51.0/255.0 blue:51.0/255.0 alpha:1.0];
        self.activityIndicatorColor = [UIColor colorWithRed:51.0/255.0 green:51.0/255.0 blue:51.0/255.0 alpha:1.0];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		_progress = 0.f;
		_annular = NO;
        _progressTintColor = [[UIColor alloc] initWithRed:191.0/255.0 green:200.0/255.0 blue:200.0/255.0 alpha:1.0];
        _backgroundTintColor = [[UIColor alloc] initWithRed:233.0/255.0 green:233.0/255.0 blue:233.0/255.0 alpha:1.0];
        ...
        _label.textColor = [[UIColor alloc] initWithRed:191.0/255.0 green:200.0/255.0 blue:200.0/255.0 alpha:1.0];
        _label.font = [UIFont systemFontOfSize:kDetailsLabelFontSize];
        _label.text = @"0%";
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		_progress = 0.f;
        _lineColor = [UIColor colorWithRed:51.0/255.0 green:51.0/255.0 blue:51.0/255.0 alpha:1.0];
        _progressColor = [UIColor colorWithRed:51.0/255.0 green:51.0/255.0 blue:51.0/255.0 alpha:1.0];
